...
class HistoryArchiver:
    ...
    def __init__(self, api_key: str, model: str="gpt-5.4-nano", archive_length: int=100, prompt: str=PROMPT_EN):
...
class EntityExtractor:
    ...
    def __init__(self, api_key: str, model: str="gpt-5.4-mini", prompt: str=PROMPT_EN):
        self.api_key = api_key
        self.model = model
...
<rules>
1. 重要度が極めて低いと思われる情報は廃棄する(ただし保守的に判断すること)
...
# Memory manager
class ChatMemory:
    def __init__(self, api_key: str=None, model: str="gpt-5.4-nano", history_archiver: HistoryArchiver=None, entity_extractor: EntityExtractor=None):
